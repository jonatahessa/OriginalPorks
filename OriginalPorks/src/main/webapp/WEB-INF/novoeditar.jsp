              ...
              <form id="formulario" class="col-xs-12 col-sm-12 col-lg-6" action="Salvar" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <select id="select-tipo" class="form-control" name="tipo">
                          <option value="CLASSICA" ${produto.tipo == 'CLASSICA' ? 'selected' : ''}>Pizza Clássica</option>
                          <option value="ORIGINAL" ${produto.tipo == 'ORIGINAL' ? 'selected' : ''}>Pizza Original</option>
                          <option value="LIGHT" ${produto.tipo == 'LIGHT' ? 'selected' : ''}>Pizza Light</option>
                          <option value="ESPECIAL" ${produto.tipo == 'ESPECIAL' ? 'selected' : ''}>Pizza Especial</option>
