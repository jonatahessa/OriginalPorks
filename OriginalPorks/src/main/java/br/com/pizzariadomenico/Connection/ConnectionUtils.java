...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "porks01.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "porks01"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "porks01"; // Nome de usuario
