...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "porks02.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "porks02"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "porks02"; // Nome de usuario
